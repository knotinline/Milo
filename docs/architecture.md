...
Milo is not a generic AI gateway. It is a controlled web client for ChatGPT.

The parent blocks the official ChatGPT webpage for the child's account. The child uses Milo instead.

```text
Parent blocks chat.openai.com / chatgpt.com
              │
              ▼
Child browser -> Milo Web App -> Input Safety Check -> ChatGPT API
                                              │              │
