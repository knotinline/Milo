...
The child may try to bypass Milo and open the official ChatGPT site. This project assumes the parent has already blocked the official ChatGPT webpage for the child's account/device.

### 2. Prompt injection and jailbreak attempts

The child may ask Milo to ignore rules, pretend they are older, disable parental mode, encode answers, or reveal hidden instructions.
...
- Milo acts as the only permitted interface.
